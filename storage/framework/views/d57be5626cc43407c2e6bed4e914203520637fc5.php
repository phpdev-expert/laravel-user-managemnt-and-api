...
'activeItem'=>'Edit Profile','route'=>'users.index'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <div class="card card-secondary">
          ...
          <?php echo e(Form::model($userInfo,array('route' => ['profile-update',$userInfo->id]))); ?>
          ...
          <input name="_method" type="hidden" value="PUT">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <?php echo e(Form::email('email',$userInfo->email,['type'=>'email','class'=>'form-control',
              ...
              <div class="form-group">
                ...
                <?php echo e(Form::text('phone_number',$userInfo->phone_number,['class'=>'form-control',
...
<?php echo $__env->make('layouts.after_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fullstackdeveloper/Desktop/laravel-api/resources/views/admin/users/edit-profile.blade.php ENDPATH**/ ?>